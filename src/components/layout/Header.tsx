      ...
      <div className="container flex items-center justify-between h-16 md:h-20">
                    ...
                    <div className="bg-background rounded-lg shadow-elevated border border-border py-2 min-w-[200px]">
                      {item.children.map((child) => (
                        <Link
                          key={child.label}
                          to={child.href}
                          className="block px-4 py-2.5 text-sm text-foreground/70 hover:text-foreground hover:bg-muted transition-colors"
                        >
                          {child.label}
                        </Link>
                      ))}
        ...
        <div className="flex items-center gap-1 md:gap-2">
          <button
            ...
            className="p-2.5 rounded-full text-foreground/70 hover:text-foreground hover:bg-muted transition-colors"
            aria-label="Ara"
          >
            ...
            <div className="container py-4">
              <div className="relative max-w-xl mx-auto">
                ...
                <input
                  ...
                  autoFocus
                  className="w-full pl-12 pr-4 py-3 rounded-full bg-muted border-0 text-foreground placeholder:text-muted-foreground focus:outline-none focus:ring-2 focus:ring-primary/20"
                />
              </div>
            </div>
          </motion.div>
